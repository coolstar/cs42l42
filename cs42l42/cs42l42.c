...
)
{
	...
	Cs42l42CompleteIdleIrp(pDevice);
...
)
{
	...
	PCS42L42_CONTEXT deviceContext;
...
NTSTATUS
Cs42l42ProcessIdleRequest(
	IN PCS42L42_CONTEXT pDevice,
...
)
{
	...
	*Complete = TRUE;
...

	{
		...
		WDF_WORKITEM_CONFIG_INIT(&workitemConfig, Cs42l42IdleIrpWorkItem);
...
)
{
	...
	case IOCTL_HID_SEND_IDLE_NOTIFICATION_REQUEST:
		...
		status = Cs42l42ProcessIdleRequest(devContext, Request, &completeRequest);
		break;
